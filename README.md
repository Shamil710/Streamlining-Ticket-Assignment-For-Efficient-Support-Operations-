...
###   Add Choice Values to Issues Choices include: 
...
-	Use **Application Access** section of the `Operations Related` table. - Require `Platform_role` and `Certificate_role` for read/write permissions. 
